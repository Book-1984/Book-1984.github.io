...
_'Attention! Your attention, please! A newsflash has this moment arrived
...
the human heritage. He went back to the table, dipped his pen, and wrote:
   ...
   _To the future or to the past, to a time when thought is free, when men
are different from one another and do not live alone--to a time when truth
exists and what is done cannot be undone:_
   _From the age of uniformity, from the age of solitude, from the age of
Big Brother, from the age of doublethink--greetings!_
...
[Next](/docs/1984-part-1-chapter-3/)
</div>
